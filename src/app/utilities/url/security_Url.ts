export class Security_Url{
    // static readonly permissionUrl = "https://vcsecurityccwebapi.azurewebsites.net/api/Permission"
    // static readonly placeUrl = "https://vcsecurityccwebapi.azurewebsites.net/api/Place"
